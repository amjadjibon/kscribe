...
func Layout(title string, content templ.Component) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 2, "</title><link rel=\"stylesheet\" href=\"https://cdn.jsdelivr.net/npm/@picocss/pico@2/css/pico.min.css\"><script src=\"https://unpkg.com/htmx.org@2.0.3\" crossorigin=\"anonymous\"></script><script src=\"https://unpkg.com/htmx-ext-sse@2.2.2/sse.js\" crossorigin=\"anonymous\"></script><style>\n\t\t\t\t.badge { display:inline-block; padding:.2em .5em; border-radius:4px; font-size:.8em; font-weight:600; }\n\t\t\t\t.badge-pending    { background:#e0e0e0; color:#555; }\n\t\t\t\t.badge-diagnosing { background:#bbdefb; color:#1565c0; }\n\t\t\t\t.badge-done       { background:#c8e6c9; color:#1b5e20; }\n\t\t\t\t.badge-partial    { background:#fff9c4; color:#f57f17; }\n\t\t\t\t.badge-failed     { background:#ffcdd2; color:#b71c1c; }\n\t\t\t</style></head><body><main class=\"container\"><nav><a href=\"/\"><strong>kscribe</strong></a></nav>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
